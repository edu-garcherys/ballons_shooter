    ...
    public void SetPosition(ViewportPosition p)
    {
      ...
      switch (p)
      {
        ...
        case ViewportPosition.CENTER:
          ...
          break;
        case ViewportPosition.CENTER_LEFT:
          coordonnees = new Vector2(_game.GraphicsDevice.Viewport.Width / 3, _game.GraphicsDevice.Viewport.Height / 2);
          break;
        case ViewportPosition.CENTER_RIGHT:
